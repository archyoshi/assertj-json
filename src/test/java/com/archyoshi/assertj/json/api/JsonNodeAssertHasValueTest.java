...
class JsonNodeAssertHasValueTest {
    ...
    @Test
    void shouldPassIfJsonFieldHasExpectedStringValue() {
    ...
    @Test
    void shouldFailIfJsonFieldDoesNotExist() {
        final JsonNode actual = mapper.convertValue(Map.of("status", "active"), JsonNode.class);
